...
public class GUI_CU_01_Registrar_Producto extends AppCompatActivity implements View.OnClickListener {
    ...
    public GUI_CU_01_Registrar_Producto() {
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gui_cu01_registrar_producto);
        esImagenCargada = false;
        nombreEdiText = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Nombre_EditText);
        marcaEditText = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Marca_EditText);
        descripcionEditText = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Descripcion_EditText);
        categoriaSpinner = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Categoria_Spinner);
        precioEdiText = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Precio_EditText);
        puntosFidelidadSpinner = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Puntos_Fidelidad_Spinner);
        tamanoEditText = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Tamano_Producto_EditText);
        tipoEnvaseSpinner = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Tipo_Envase_Spinner);
        cantidadExistenciaEditText = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Cantidad_Existencia_EditText);
        rutaImgenTextView = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Ruta_Imagen_TextView);
        registrarButton = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Registrar_Button);
        seleccionarImagenButton = findViewById(R.id.Activity_GUI_CU_01_Registrar_Producto_Seleccionar_Imagen_Button);
        storageReference = FirebaseStorage.getInstance().getReference();
        registrarButton.setOnClickListener(GUI_CU_01_Registrar_Producto.this);
        seleccionarImagenButton.setOnClickListener(GUI_CU_01_Registrar_Producto.this);
        llenarSpinners();
    ...
    public void llenarSpinners(){
        ...
        categoriaSpinner.setAdapter(new ArrayAdapter<String>(GUI_CU_01_Registrar_Producto.this, android.R.layout.simple_spinner_dropdown_item, listaCategorias));
        tipoEnvaseSpinner.setAdapter(new ArrayAdapter<String>(GUI_CU_01_Registrar_Producto.this, android.R.layout.simple_spinner_dropdown_item, listaEnvases));
        puntosFidelidadSpinner.setAdapter(new ArrayAdapter<Integer>(GUI_CU_01_Registrar_Producto.this, android.R.layout.simple_spinner_dropdown_item, listaPuntosFidelidad));
    }
    ...
    private void registrarProducto(){
        if(validarFormulario()) {
            ...
            Call<Producto> call = RetrofitCliente.getInstanceSinglenton().getApiServicioProducto().registrarProducto(producto);
            call.enqueue(new Callback<Producto>() {
                @Override
                public void onResponse(Call<Producto> call, Response<Producto> response) {
                    if(response.isSuccessful()){
                        Toast.makeText(GUI_CU_01_Registrar_Producto.this, "Mensaje confirmacion : " + response.message() , Toast.LENGTH_SHORT).show();
                        Toast.makeText(GUI_CU_01_Registrar_Producto.this, "Poducto registrado: " + response.body().getNombre() , Toast.LENGTH_SHORT).show();
                    }else{
                        Toast.makeText(GUI_CU_01_Registrar_Producto.this, "Mensaje de error: " + response.message() , Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(GUI_CU_01_Registrar_Producto.this, "Mensaje de error: " + t.getMessage() , Toast.LENGTH_SHORT).show();
                }
            });

            Intent intent = new Intent( GUI_CU_01_Registrar_Producto.this, GUI_CU_Gestionar_Producto.class);
    ...
    public void onClick(View v) {
        switch(v.getId()){
            case R.id.Activity_GUI_CU_01_Registrar_Producto_Registrar_Button:
                registrarProducto();
                break;
            case R.id.Activity_GUI_CU_01_Registrar_Producto_Seleccionar_Imagen_Button:
                seleccionarImagen();
                break;
        }
    }
    ...
    private String getFileExtension(Uri uri){
        ContentResolver contentResolver = GUI_CU_01_Registrar_Producto.this.getContentResolver();
